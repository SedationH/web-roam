...
;(function (global, factory) {
    ...
    (function (window) {
      ...
      isXML = Sizzle.isXML = function (elem) {
        var namespace = elem.namespaceURI,
          docElem = (elem.ownerDocument || elem)
            .documentElement
      ...
      setDocument = Sizzle.setDocument = function (node) {
        ...
        support.scope = assert(function (el) {
          ...
          return (
            ...
            !el.querySelectorAll(":scope fieldset div")
              .length
          )
        })
	...
	---------------------------------------------------------------------- */
      ...
      Sizzle.attr = function (elem, name) {
        ...
        var fn = Expr.attrHandle[name.toLowerCase()],
          ...
          val =
            fn &&
            hasOwn.call(Expr.attrHandle, name.toLowerCase())
  ...
  jQuery.extend({
    ...
    ready: function (wait) {
      ...
      if (
        wait === true ? --jQuery.readyWait : jQuery.isReady
      ) {
        return
      }
    ...
    if (initialInUnit && initialInUnit[3] !== unit) {
      ...
      while (maxIterations--) {
        ...
        if (
          (1 - scale) *
            (1 -
              (scale = currentValue() / initial || 0.5)) <=
          0
        ) {
          maxIterations = 0
        }
  ...
  function expectSync(elem, type) {
    return (
      (elem === safeActiveElement()) === (type === "focus")
    )
  }
  ...
  jQuery.event = {
    ...
    remove: function (
      ...
      var j,
        ...
        origType,
        elemData =
          dataPriv.hasData(elem) && dataPriv.get(elem)
  ...
  function finalPropName(name) {
    ...
    return (vendorProps[name] =
      vendorPropName(name) || name)
  }
  ...
  jQuery.parseXML = function (data) {
    ...
    try {
      xml = new window.DOMParser().parseFromString(
        data,
        "text/xml"
      )
    } catch (e) {
  ...
  jQuery.ajaxTransport(function (options) {
    ...
    if (
      support.cors ||
      (xhrSupported && !options.crossDomain)
    ) {
      return {
  ...
  jQuery.ajaxPrefilter("json jsonp", function (
    ...
    if (jsonProp || s.dataTypes[0] === "jsonp") {
      ...
      callbackName = s.jsonpCallback = isFunction(
        s.jsonpCallback
      )
        ? s.jsonpCallback()
        : s.jsonpCallback
