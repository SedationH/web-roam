...
},{"./vnode":"../node_modules/snabbdom/es/vnode.js","./is":"../node_modules/snabbdom/es/is.js","./htmldomapi":"../node_modules/snabbdom/es/htmldomapi.js","./h":"../node_modules/snabbdom/es/h.js","./thunk":"../node_modules/snabbdom/es/thunk.js"}],"00use.js":[function(require,module,exports) {
"use strict";

var _snabbdom = require("snabbdom");

var patch = (0, _snabbdom.init)([]); // 创建虚拟的节点

var vnode = (0, _snabbdom.h)("div#container", "Hello World"); // 寻找替换的根节点

var app = document.querySelector("#00use"); // 第一次使用要挂载一个真实的DOM

var oldVnode = patch(app, vnode); // patch返回一个虚拟DOM

console.log(oldVnode);
vnode = (0, _snabbdom.h)("div#container.cls", [(0, _snabbdom.h)("h1", "Hello Snabbdom"), (0, _snabbdom.h)("p", "这是一个p标签")]);
setTimeout(function () {
  patch(oldVnode, vnode);
}, 2000);
},{"snabbdom":"../node_modules/snabbdom/es/snabbdom.js"}],"../node_modules/snabbdom/modules/style.js":[function(require,module,exports) {
"use strict";
...
}, [(0, _snabbdom.h)("h1", "Hello Snabbdom"), (0, _snabbdom.h)("p", "这是p标签")]);
...
var oldVnode = patch(app, vnode); // vnode = h("div", "hello")
// patch(oldVnode, vnode)
},{"./00use":"00use.js","snabbdom":"../node_modules/snabbdom/es/snabbdom.js","snabbdom/modules/style":"../node_modules/snabbdom/modules/style.js","snabbdom/modules/eventlisteners":"../node_modules/snabbdom/modules/eventlisteners.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
