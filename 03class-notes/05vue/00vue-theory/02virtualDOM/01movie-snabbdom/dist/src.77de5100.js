...
var style_1 = __importDefault(require("snabbdom/modules/style"));

var eventlisteners_1 = __importDefault(require("snabbdom/modules/eventlisteners"));

var patch = snabbdom_1.init([class_1.default, props_1.default, style_1.default, eventlisteners_1.default]);
var vnode;
var nextKey = 11;
var margin = 8;
var sortBy = "rank";
...
function movieView(movie) {
  ...
  }, movie.rank), snabbdom_1.h("div", movie.title), snabbdom_1.h("div", movie.desc), snabbdom_1.h("div.btn.rm-btn", {
    on: {
      click: [remove, movie]
    }
  }, "x")]);
...
function view(data) {
  return snabbdom_1.h("div", [snabbdom_1.h("h1", "Top 10 movies"), snabbdom_1.h("div", [snabbdom_1.h("a.btn.add", {
    on: {
      click: add
    }
  }, "Add"), "Sort by: ", snabbdom_1.h("span.btn-group", [snabbdom_1.h("a.btn.rank", {
    class: {
      active: sortBy === "rank"
    },
    on: {
  ...
  }, "Description")])]), snabbdom_1.h("div.list", {
    style: {
